...
CreateLambdaConvar( "lambdaplayers_lambda_laughonkilled", 1, true, false, false, "If Lambda Player should have a random chance to laugh when witnessing someone die", 0, 1, { type = "Bool", name = "Laugh At Witnessing Death", category = "Lambda Server Settings" } )
...
CreateLambdaConvar( "lambdaplayers_lambda_lethalwaters", 0, true, false, false, "If enabled, disables swimming for Lambda Players and take more drowning damage quicker. Useful for maps with water where players can't get out with normal ways", 0, 1, { type = "Bool", name = "Lethal Waters", category = "Lambda Server Settings" } )
...
CreateLambdaConvar( "lambdaplayers_combat_tbagkilledenemy", 1, true, false, false, "If enabled, after killing their enemy Lambda Player has a chance to t-bag their corpse", 0, 1, { type = "Bool", name = "T-Bag Killed Enemy", category = "Combat" } )
